...
class GameVC: UIViewController, PlayAgainDelegate {
    ...
    // this method is called whenever the focused item changes.. Only needed for tvOS
    ...
    func createLabelsAndButtons() {
        ...
        let bottomHorizontalStack = UIStackView(arrangedSubviews: [howToButton, quitButton, resetButton, pauseButton, saveButton])
...
extension GameVC: newScoreAddedDelegate {
